...
export default function Home() {
  return (
    <div>
      ...
      <div className="my-28 flex flex-row items-center justify-center gap-8">
      ...
      <div className="my-12 flex flex-row items-center justify-center gap-14">
        <Image src="/home/reservation.png" width={480} height={284} alt="home-reservation-list" />
        <div className="flex w-[616px] flex-col items-start">
          <Brand text="Discover and Reserve the Perfect Co-Working Space for Your Needs" className="text-left"/>
          <br></br>
          <p className="text-navy"> 
            Our platform makes it easy to find and book co-working spaces that meet
            your requirements. With just a few clicks, you can secure a workspace that
            suits your needs and preferences. 
          </p>
          <br></br>
          <div className="flex flex-row gap-6">
            <Benefit title="Convenient" description="Effortlessly search and reserve co-working spaces with our user-friendly platform."/>
            <Benefit title="Flexible" description="Customize your workspace by adding facilities according to your specific needs."/>
          </div>
        </div>
      </div>
    </div>
