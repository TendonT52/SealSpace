  ...
  const reservations: Reservation[] = [
    {
      ...
      reservation: [
        { id: "1", date: 1, month: "Dec", year: 2023, rooms: 2, amenities: "WiFi, Parking" },
    ...
    },
    {
      ...
      reservation: [
        { id: "4", date: 11, month: "Dec", year: 2023, rooms: 2, amenities: "WiFi, Parking" },
    ...
    },
    {
      ...
      reservation: [
        { id: "7", date: 1, month: "Nov", year: 2023, rooms: 2, amenities: "WiFi, Parking" },
    ...
    },
    {
      ...
      reservation: [
        { id: "10", date: 1, month: "Feb", year: 2023, rooms: 1, amenities: "WiFi, Parking" },
    ...
    },
    {
      ...
      reservation: [
        { id: "12", date: 9, month: "Feb", year: 2023, rooms: 1, amenities: "Parking" },
          ...
          {reservations.map((reservation) => (
            ...
            >
              <Card
                ...
                style={selectedReservation.id === reservation.id ? "selected" : "default"}
              />
            </div>
          ))}
        </div>
