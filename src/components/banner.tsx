...
export default function Banner({
  ...
  return (
    <button
      ...
      ${isHovered ? "cursor-pointer hover:drop-shadow-md" : "cursor-default"}`}
    >
      ...
      <h1
        className={`
        inline-block bg-gradient-to-b from-mint to-cyan bg-clip-text font-nunito text-3xl font-bold text-transparent
        ${isHovered ? "bg-gradient-to-b from-mint to-navy" : "bg-gradient-to-b from-mint to-cyan"}
      `}
      >
        Seal Space
      </h1>
